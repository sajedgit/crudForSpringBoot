...
function get_request_dto_data($arr,$table_name,$request_name,$model_name,$package_name,$author_name)
{
	$today = date("d M, Y");
	$str="";
...
/**
 * This class is to provide $model_name request
 *
 * @author $author_name
 * @since $today
 * @version 1.0
 */
@Data
public class $request_name extends IdHolderRequestBodyDTO {
